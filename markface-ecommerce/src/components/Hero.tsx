      ...
      <div className="relative h-[600px] w-full overflow-hidden rounded-xl bg-slate-200">
        ...
        <div className="relative h-full flex flex-col justify-center px-12 md:px-24 text-white max-w-3xl">
          ...
          <div className="flex gap-4">
            <Link 
              href="/catalog" 
              className="bg-primary hover:bg-primary/90 text-white px-8 py-4 rounded-xl font-bold transition-all transform hover:scale-105 inline-block"
            >
              Comprar Coleção
            </Link>
            <Link 
              href="/catalog" 
              className="bg-white/10 backdrop-blur-md border border-white/20 hover:bg-white/20 text-white px-8 py-4 rounded-xl font-bold transition-all inline-block"
            >
              Ver Lookbook
            </Link>
          </div>
