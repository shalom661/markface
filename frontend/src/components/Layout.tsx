...
import { LogOut, Package, ShoppingCart, Truck, Scissors, LayoutDashboard, FileUp, Moon, Sun, User as UserIcon, Settings } from 'lucide-react';
...
export default function Layout() {
    ...
    return (
        <div className="flex h-screen flex-col lg:flex-row bg-muted/20 overflow-hidden">
            {/* Sidebar */}
            <aside className="w-full lg:w-64 border-r bg-card shadow-sm flex-shrink-0 flex flex-col h-auto lg:h-full">
